// Default Mock & Seed Quizzes Dataset for QuizNova

export const GAMES_DATA = [
  {
    name: "COMIC BOOK SUPERHEROES #1",
...
export const NEW_QUIZZES = [
  ...
  {
    id: 3,
    title: "Name That Greek God Quiz",
    desc: "Prepare for your next trip to Mount Olympus by identifying...",
    image: "https://images.unsplash.com/photo-1533518463841-d62e1fc91373?auto=format&fit=crop&w=200&q=80",
    category: "Mythology",
    difficulty: "Medium",
    isNewQuiz: true,
    questions: [
  ...
  {
    id: 4,
    title: "Former Names of Current Places Quiz",
    desc: "What is New Amsterdam called today?",
    image: "https://images.unsplash.com/photo-1449034446853-66c86144b0ad?auto=format&fit=crop&w=200&q=80",
    category: "History",
    difficulty: "Medium",
    isNewQuiz: true,
    questions: [
  ...
  {
    id: 5,
    title: "What Very Big Thing Happened on This Day?",
    desc: "Are you up to date on your famous historical dates?",
    image: "https://images.unsplash.com/photo-1510662145379-13537db782dc?auto=format&fit=crop&w=200&q=80",
    category: "History",
    difficulty: "Hard",
    isNewQuiz: true,
    questions: [
...
export const EDITORS_PICKS_DATA = [
...
export const EDITORS_PICKS_QUESTIONS = {
  10: [
    { q: "What is a baby kangaroo called?", options: ["Joey", "Cub", "Pup", "Kit"], ans: 0, exp: "A baby kangaroo is called a Joey and lives in its mother's pouch." },
    { q: "What is a baby swan called?", options: ["Cygnet", "Chick", "Fawn", "Duckling"], ans: 0, exp: "Baby swans are called cygnets." },
    { q: "What is a baby cat called?", options: ["Kitten", "Pup", "Cub", "Foal"], ans: 0, exp: "A baby cat is called a kitten or kitty." }
  ],
  11: [
    { q: "Which country borders both France and Germany?", options: ["Luxembourg", "Belgium", "Switzerland", "Netherlands"], ans: 0, exp: "Luxembourg borders France, Germany, and Belgium." },
    { q: "Brazil shares a border with how many South American countries?", options: ["10", "7", "9", "5"], ans: 0, exp: "Brazil borders 10 of the 12 South American countries." },
    { q: "Which African country is completely surrounded by South Africa?", options: ["Lesotho", "Swaziland", "Botswana", "Zimbabwe"], ans: 0, exp: "Lesotho is an enclave completely surrounded by South Africa." }
  ],
  12: [
    { q: "Is a tomato a fruit or vegetable?", options: ["Fruit", "Vegetable", "Berry", "Both"], ans: 0, exp: "Botanically, a tomato is a fruit as it develops from the flower." },
    { q: "Is a pumpkin a fruit or vegetable?", options: ["Fruit", "Vegetable", "Gourd", "Seed"], ans: 0, exp: "A pumpkin is botanically a fruit since it contains seeds." },
    { q: "Is avocado a fruit or vegetable?", options: ["Fruit", "Vegetable", "Nut", "Legume"], ans: 0, exp: "Avocado is a fruit — specifically a large berry." }
  ],
  13: [
    { q: "Which dinosaur had three horns on its face?", options: ["Triceratops", "Stegosaurus", "Brachiosaurus", "Ankylosaurus"], ans: 0, exp: "Triceratops means 'three-horned face' in Latin." },
    { q: "What does 'Tyrannosaurus' mean?", options: ["Tyrant lizard", "Giant snake", "Fast runner", "Sharp claw"], ans: 0, exp: "T-Rex means 'tyrant lizard king'." },
    { q: "Which dinosaur is famous for its spiked tail?", options: ["Stegosaurus", "Diplodocus", "Iguanodon", "Pachycephalosaurus"], ans: 0, exp: "Stegosaurus had a spiked tail called a thagomizer." }
  ],
  14: [
    { q: "In which city is the Statue of Liberty located?", options: ["New York", "Washington DC", "Boston", "Philadelphia"], ans: 0, exp: "The Statue of Liberty is on Liberty Island in New York Harbor." },
    { q: "The Sagrada Familia cathedral is in which city?", options: ["Barcelona", "Madrid", "Lisbon", "Rome"], ans: 0, exp: "Sagrada Familia is in Barcelona, Spain, designed by Gaudí." },
    { q: "The Acropolis is located in which city?", options: ["Athens", "Rome", "Cairo", "Istanbul"], ans: 0, exp: "The Acropolis is a famous ancient citadel in Athens, Greece." }
  ],
  15: [
    { q: "What does the symbol '♻' represent?", options: ["Recycling", "Energy", "Water", "Peace"], ans: 0, exp: "The universal recycling symbol was designed in 1970." },
    { q: "What does a red cross symbol usually indicate?", options: ["Medical / First Aid", "Stop", "Danger", "War zone"], ans: 0, exp: "The Red Cross is an international humanitarian symbol." },
    { q: "What does the '@' symbol represent in email?", options: ["At", "About", "Address", "Account"], ans: 0, exp: "'@' means 'at', used to indicate the email provider domain." }
  ],
  16: [
    { q: "What is the capital of California?", options: ["Sacramento", "Los Angeles", "San Francisco", "San Diego"], ans: 0, exp: "Sacramento has been California's capital since 1854." },
    { q: "What is the capital of Texas?", options: ["Austin", "Houston", "Dallas", "San Antonio"], ans: 0, exp: "Austin is the capital of Texas and home to UT Austin." },
    { q: "What is the capital of New York State?", options: ["Albany", "New York City", "Buffalo", "Rochester"], ans: 0, exp: "Albany is the capital of New York State, not New York City." }
  ],
  17: [
    { q: "Who was the first US President?", options: ["George Washington", "John Adams", "Thomas Jefferson", "Benjamin Franklin"], ans: 0, exp: "George Washington became the first US President in 1789." },
    { q: "Who commanded Union forces at Gettysburg?", options: ["George Meade", "Ulysses Grant", "William Sherman", "Philip Sheridan"], ans: 0, exp: "General George Gordon Meade commanded at Gettysburg in July 1863." },
    { q: "Which general is famous for 'I shall return' pledge?", options: ["Douglas MacArthur", "Dwight Eisenhower", "George Patton", "Omar Bradley"], ans: 0, exp: "General Douglas MacArthur said 'I shall return' when leaving the Philippines in 1942." }
  ]
};

export const POPULAR_QUESTIONS = {
  20: [
    { q: "Who painted the Mona Lisa?", options: ["Leonardo da Vinci", "Michelangelo", "Raphael", "Titian"], ans: 0, exp: "Leonardo da Vinci painted the Mona Lisa between 1503 and 1519." },
    { q: "Who wrote 'Pride and Prejudice'?", options: ["Jane Austen", "Charlotte Brontë", "Mary Shelley", "George Eliot"], ans: 0, exp: "Jane Austen wrote Pride and Prejudice, published in 1813." },
    { q: "Who invented the telephone?", options: ["Alexander Graham Bell", "Thomas Edison", "Nikola Tesla", "Guglielmo Marconi"], ans: 0, exp: "Alexander Graham Bell is credited with inventing the telephone in 1876." }
  ],
  21: [
    { q: "What is the chemical symbol for Gold?", options: ["Au", "Ag", "Fe", "Cu"], ans: 0, exp: "Gold's symbol Au comes from the Latin word Aurum." },
    { q: "What is the atomic number of Carbon?", options: ["6", "12", "8", "14"], ans: 0, exp: "Carbon has atomic number 6, meaning it has 6 protons." },
    { q: "Which element has the symbol 'Na'?", options: ["Sodium", "Nitrogen", "Neon", "Nickel"], ans: 0, exp: "Na comes from Natrium, the Latin word for sodium." }
  ],
  22: [
    { q: "What is the capital of Australia?", options: ["Canberra", "Sydney", "Melbourne", "Brisbane"], ans: 0, exp: "Canberra is the capital of Australia, chosen as a compromise between Sydney and Melbourne." },
    { q: "Which is the largest ocean?", options: ["Pacific", "Atlantic", "Indian", "Arctic"], ans: 0, exp: "The Pacific Ocean is the largest and deepest ocean on Earth." },
    { q: "Which mountain range separates Europe from Asia?", options: ["Ural Mountains", "Alps", "Himalayas", "Caucasus"], ans: 0, exp: "The Ural Mountains are traditionally considered the boundary between Europe and Asia." }
  ],
  23: [
    { q: "Where is the Eiffel Tower located?", options: ["Paris", "London", "Berlin", "Rome"], ans: 0, exp: "The Eiffel Tower is on the Champ de Mars in Paris, France." },
    { q: "The Great Wall of China was built to protect against invasions from which direction?", options: ["North", "South", "East", "West"], ans: 0, exp: "The Great Wall was built along China's northern border to defend against nomadic invasions." },
    { q: "In which country is Machu Picchu located?", options: ["Peru", "Bolivia", "Ecuador", "Colombia"], ans: 0, exp: "Machu Picchu is an Incan citadel in the Andes Mountains of Peru." }
  ]
};
